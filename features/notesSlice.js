...
export const fetchPosts = createAsyncThunk("training/fetchPosts", async () => {
...
export const addNewPost = createAsyncThunk(
  "notes/addNewPost",
  async (newPost) => {
    await setDoc(doc(db, "training", newPost.id), newPost);
    return newPost;
  }
);
...
export const updatePostThunk = createAsyncThunk(
  "posts/updatePost",
  async (updatedPost) => {
    await updateDoc(doc(db, "training", updatedPost.id), updatedPost);
    return updatedPost;
  }
);
